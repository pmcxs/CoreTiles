...
namespace CoreTiles.Drawing
{
    public static class BresenhamLineAlgorithm
    {
        ...
        public static void DrawLine(Image image, int x1, int y1, int x2, int y2, Color color)
        {
            int w = x2 - x1;
            int h = y2 - y1;
        ...
        /// <returns></returns>
        public static IEnumerable<Point> GetNonDiagonalPointsOfLine(int x0, int y0, int x1, int y1, int maxDistance)
        {
